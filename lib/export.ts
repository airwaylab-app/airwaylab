...
export function exportCSV(nights: NightResult[]): string {
  ...
  const rows = nights.map((n) => [
    ...
    n.sessionCount,
    n.settings.settingsSource === 'unavailable' ? 'N/A' : n.settings.papMode,
    n.settings.settingsSource === 'unavailable' ? 'N/A' : n.settings.epap,
    n.settings.settingsSource === 'unavailable' ? 'N/A' : n.settings.ipap,
    n.settings.settingsSource === 'unavailable' ? 'N/A' : n.settings.pressureSupport,
