...
export function exportForumSingleNight(n: NightResult): string {
  ...
  lines.push('---');
  lines.push('*Generated by [AirwayLab](https://airwaylab.app) — free, open-source airway analysis. Your data never leaves your browser. [⭐ Star AirwayLab on GitHub — help others find it](https://github.com/airwaylab-app/airwaylab)*');
