...
export function exportForumSingleNight(n: NightResult, tier?: Tier): string {
  ...
  lines.push('---');
  lines.push(`*Generated by [AirwayLab](https://airwaylab.app)${tierBadge(tier)} — free, open-source PAP analysis. Your data never leaves your browser. [⭐ Star on GitHub](https://github.com/airwaylab-app/airwaylab)*`);
