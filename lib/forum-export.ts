...
export function exportForumSingleNight(n: NightResult, tier?: Tier): string {
  ...
  lines.push('---');
  lines.push(`*Generated by [AirwayLab](https://airwaylab.app)${tierBadge(tier)} — free, open-source airway analysis. Your data never leaves your browser. [⭐ Star AirwayLab on GitHub — help others find it](https://github.com/airwaylab-app/airwaylab)*`);
