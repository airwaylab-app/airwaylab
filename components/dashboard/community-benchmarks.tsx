    ...
    <div className="rounded-xl border border-border/50 bg-card/30 px-4 py-4">
      ...
      {!isPaid && (
        <div className="mt-3 flex items-center gap-2 border-t border-border/30 pt-3 text-[11px] text-muted-foreground/60">
          ...
          <span>
            {isElevated
              ? 'Your flow limitation metrics are above the community midpoint for this dataset. Supporters get deeper AI analysis of cross-engine correlations in their data.'
              : 'Your results are within the typical range for this dataset. Supporters get AI analysis of cross-engine correlations in their data.'}
            {' '}
