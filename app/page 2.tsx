          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
            ...
            <div className="flex flex-1 flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <Link
                  href="/about"
                  className="text-center text-xs text-muted-foreground transition-colors hover:text-foreground sm:text-sm"
                >
            ...
            {/* Right: Mocked dashboard metrics */}
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          <div>
            ...
            <p className="mt-2 max-w-lg text-sm text-muted-foreground">
              SleepScope fills the gap between OSCAR&apos;s raw signal viewer and the clinical sleep lab.
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <a
              href="https://github.com/sleepscope-app/sleepscope"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg border border-border/50 bg-card/50 px-4 py-2 text-xs text-muted-foreground transition-colors hover:border-border hover:text-foreground"
            >
