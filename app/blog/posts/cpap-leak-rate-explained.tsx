    ...
    <article>
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 space-y-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
          ...
          <p>
            Not all leak is a problem. This is the distinction that most CPAP apps don&apos;t
          ...
          <p>
            ...
            on its own. The unintentional leak figure is the more relevant one to review.
          </p>
      ...
      <section className="mt-8 border-t border-border/30 pt-6">
        ...
        <div className="space-y-1 text-sm text-muted-foreground">
          <p>
            <Link
              href="/blog/understanding-cpap-data"
              className="text-primary hover:text-primary/80"
            >
              Understanding Your CPAP Data: A Plain-Language Guide
            </Link>{' '}
